...
public class part2Ex4 {
	...
	public static void main(String[] args) {
	    ...
	    while(true) {
	    	...
	    	if(ch==1) {
	    		if(콜라재고>0) {
	    			콜라재고--; 콜라바구니++; System.out.println("안내) 콜라 담았습니다.");
	    		}
	    		...
	    		{
		    		if(환타재고>0) {
		    			환타재고--; 환타바구니 ++; System.out.println("안내) 환타 담았습니다.");
		    		}
	    		...
	    		{
		    		if(사이다재고>0) {
		    			사이다재고--; 사이다바구니 ++; System.out.println("안내) 사이다 담았습니다.");
		    		}
	    		...
	    		if(ch2==1) {
	    			...
	    			콜라바구니=0; 환타바구니=0 ; 사이다바구니=0;
	    			System.out.println("투입금액이 적습니다. 시작화면으로 돌아갑니다.");
	    			}
	    		}
	    		else if(ch2==2) {콜라재고 +=콜라바구니 ; 환타재고 += 환타바구니 ; 사이다재고 += 사이다바구니;
	    			콜라바구니=0; 환타바구니=0 ; 사이다바구니=0;
	    			System.out.println("결제실패 초기화면으로 돌아갑니다.");
	    		}
