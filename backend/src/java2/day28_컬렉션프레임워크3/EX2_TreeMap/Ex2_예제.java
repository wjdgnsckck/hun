...
public class Ex2_예제 {
	...
	public static void main(String[] args) {
		...
		System.out.println("이진트리 map 상태 : "+treeMap);//자동으로 오름차순 정렬(key 기준!)
		//오름차순 : 낮은것 -> 끝것 (123,abc,ㄱㄴㄷ)
		
		//3.
		System.out.println("가장 왼쪽 노드/엔트리 : " + treeMap.firstEntry());
		System.out.println("가장 오른쪽 노드/엔트리 : " + treeMap.lastEntry());
		System.out.println(" ever 노드 앞의 노드/엔트리 : " +treeMap.lowerEntry("ever"));
		System.out.println(" ever 노드 앞의 노드/엔트리 : " +treeMap.higherEntry("ever"));
