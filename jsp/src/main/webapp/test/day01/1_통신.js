...
function 예제1(){console.log('예제1() 실행')
	...
	/*
		...
		2. 형태 : $.ajax();
		3. 필수!!! : JQUERY 라이브리러 필수!!<script  src="http://code.jquery.com/jquery-latest.min.js"></script>
				$ is not defined : jquery 라이브러리 추가 안했을때 발생하는 오류
		4. 매개변수 : 객체{속성 : 값, 속성: 값 , 속성: 값}
			1.url속성 : 통신할 대상 /링크 /주소
			2.HTTP통신메소드 : post, get , put ,delete
			3. success결과속성 : 통신에 성공했을때 반환된 데이터를 함수의 매개변수 반환 받음
	 */
